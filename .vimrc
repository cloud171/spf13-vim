...
" }
 ...
 " Vim UI {
     ...
     if has("gui_running")
         ...
         " Custom highlight colors that changes when active or inactive for
         " base16-toromrrow theme
         " autocmd InsertEnter * hi CursorLine cterm=NONE ctermbg=237
     ...
     " Disable annoying completiion message
     set shortmess+=c
 " }
 ...
 "     " Fugitive {
     ...
     " YouCompleteMe {
         if count(g:spf13_bundle_groups, 'youcompleteme')
             ...
             " Populate quickfix list with warnings/errors
